...
export function getElements() {
  return {
    ...
    reviewAutoPrCheckbox: document.querySelector('#review-auto-pr-checkbox'),
    ...
    createdPrCompareLink: document.querySelector('#created-pr-compare-link'),
    retryCreatePrBtn: document.querySelector('#retry-create-pr-btn'),
