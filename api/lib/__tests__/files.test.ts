...
import handleFilesIndex from '../handlers/files-index'
import handleFilesDetail from '../handlers/files-detail'
import handleSchemasDetail from '../handlers/schemas-detail'
import handleValidateFile from '../handlers/validate-file'
